                                              ...
                                              let tapp$0;
                                              {
                                                ;
                                                {
                                                  let stratify2$0;
                                                  {
                                                    ...
                                                    tapp$0 = recDot(stratify2$0, "_c0.a");
                                                  }
                                                };
                                                if (either(tapp$0)) {
                                                  {
                                                      ...
                                                      let tapp$4;
                                                      {
                                                        ;
                                                        {
                                                          let stratify2$0;
                                                          {
                                                            ...
                                                            tapp$4 = recDot(stratify2$0, "_c0.b");
                                                          }
                                                        };
                                                        if (either(tapp$4)) {
                                                          {
                                                              ...
                                                              let tapp$3;
                                                              {
                                                                ;
                                                                {
                                                                  let stratify2$0;
                                                                  {
                                                                    ...
                                                                    tapp$3 = recDot(stratify2$0, "_c0.a");
                                                                  }
                                                                };
                                                                if (either(tapp$3)) {
                                                                  {
                                                                    let teitherL$0 = getLeft(tapp$3);
                                                                    {
                                                                      let stratify2$1;
                                                                      {
                                                                          ...
                                                                          let tapp$2;
                                                                          {
                                                                            ;
                                                                            {
                                                                              let stratify2$0;
                                                                              {
                                                                                ...
                                                                                tapp$2 = recDot(stratify2$0, "_c0.b");
                                                                              }
                                                                            };
                                                                            if (either(tapp$2)) {
                                                                              {
                                                                                let teitherL$0 = getLeft(tapp$2);
                                                                                stratify2$1 = teitherL$0;
                                                                              }
                                                                            } else {
                                                                              {
                                                                        ...
                                                                        stratify2 = {
                                                                            "$left": (natPlus(teitherL$0, stratify2$1))
                                                                          };
                                                                      }
                                                                    }
                                                                  }
                    ...
                    };
                    {
                      let stratify2;
                      {
                                          ...
                                          let stratify1$0;
                                          {
                                            ...
                                            };
                                            {
                                              let stratify2$0;
                                              {
                                                ...
                                                tmp0 = union(tmp0, array(recConcat({
                                                          "t1.a_b": (recDot(stratify0$0, "a_b"))
                                                        }, recConcat({
                                                            "t1.b": (recDot(stratify1$0, "_c0_b"))
                                                          }, recConcat({
                                                              "t1.c": (recDot(stratify2$0, "_c0_c"))
                                                            }, {
                                                            })))));
                                              }
                                            }
                        ...
                        };
                        {
                          ...
                          {
                            ;
                            stratify0$4 = groupBy("0", array("t1.a_b"), stratify2);;
                            {
                              let stratify3;
                              {
                                ;
                                ...
                                };
                                {
                                  let stratify4;
                                  {
                                                                          ...
                                                                          let stratify2$1;
                                                                          {
                                                                                                      ...
                                                                                                      let tappe$2;
                                                                                                      {
                                                                                                            ...
                                                                                                            });;
                                                                                                        {
                                                                                                          let stratify0$0;
                                                                                                          {
                                                                                                            ...
                                                                                                            tmp2 = union(tmp2, array(recDot(stratify0$0, "t1.c")));
                                                                                                          }
                                                                                                        }
                                                                                                      }
                                                                                                    }
                                                                            ...
                                                                            };
                                                                            {
                                                                              let stratify3$0;
                                                                              {
                                                                                ...
                                                                                tapp$6 = nth(flatten(stratify3$0), {
                                                                                      "$nat": (0.0)
                                                                                    });
                                                                              }
                                                                            }
                                    ...
                                    };
                                    {
                                      ...
                                      {
                                        ;
                                        iterColl(flatten(stratify4), (function (tmap$0) {
                                                                                        {
                                              let tappe$0;
                                              {
                                                ;
                                                  ...
                                                  let stratify0$1;
                                                  {
                                                              ...
                                                              let tappe$1;
                                                              {
                                                                    ...
                                                                    });;
                                                                {
                                                                  let stratify0$0;
                                                                  {
                                                                    ...
                                                                    tmp1 = union(tmp1, array(recDot(stratify0$0, "t1.b")));
                                                                  }
                                                                }
                                                              }
                                                            }
                                                    ...
                                                    };
                                                    {
                                                      let stratify1$0;
                                                      {
                                                        ...
                                                        tmp0 = union(tmp0, array(recConcat({
                                                                  "count_b": ({
                                                                    "$left": (count(stratify0$1))
                                                                  })
                                                                }, recConcat({
                                                                    "t1_a_b": (recDot(stratify1$0, "t1.a_b"))
                                                                  }, {
                                                                  }))));
                                                      }
                                                    }
