                                    ...
                                    };
                                    {
                                      let stratify2;
                                      {
                                        ...
                                        tmp0 = union(tmp0, array(recConcat({
                                                  "t1.d": (recDot(stratify0$0, "table1.a"))
                                                }, recConcat({
                                                    "t1.e": (recDot(stratify1, "table1.b"))
                                                  }, recConcat({
                                                      "t1.f": (recDot(stratify2, "table1.c"))
                                                    }, {
                                                    })))));
                                      }
                                    }
                                                  ...
                                                  let stratify0$0;
                                                  {
                                                    ...
                                                    };
                                                    {
                                                      let stratify1$0;
                                                      {
                                                        ...
                                                        tappe$1 = recConcat({
                                                              "a#": (recDot(stratify0$0, "t1.d"))
                                                            }, {
                                                              "b#": (recDot(stratify1$0, "_c0.a"))
                                                            });
                                                      }
                                                    }
                                                  }
