                                            ...
                                            ;
                                            {
                                              let stratify0$0;
                                              {
                                                ;
                                                {
                                                  ...
                                                  {
                                                    ;
                                                    iterColl(array((!natLe(count(recDot(constants0, "table0")), {
                                                              "$nat": (0.0)
                                                            }))), (function (tsel$1) {
                                                                                                                if (tsel$1) {
                                                ...
                                                tapp$6 = nth(flatten(stratify0$0), {
                                                      "$nat": (0.0)
                                                    });
                                              }
                                            };
                                                                                                        ...
                                                                                                        ;
                                                                                                        {
                                                                                                          let tmp1 = distinct(array());
                                                                                                          {
                                                                                                            ...
                                                                                                            iterColl(union(array(recDot(recConcat({
                                                                                                                        "table0_a": (recDot(stratify0$1, "_c0.a"))
                                                                                                                      }, recConcat({
                                                                                                                          "table0_b": (recDot(stratify1$0, "_c0.b"))
                                                                                                                        }, recConcat({
                                                                                                                            "table0_c": (recDot(stratify2, "_c0.c"))
                                                                                                                          }, {
                                                                                                                          }))), "table0_a")), union(array(recDot(recRemove(recConcat({
                                                                                                                            "table0_a": (recDot(stratify3, "_c0.a"))
                                                                                                                          }, recConcat({
                                                                                                                              "table0_b": (recDot(stratify4, "_c0.b"))
                                                                                                                            }, recConcat({
                                                                                                                                "table0_c": (recDot(stratify5, "_c0.c"))
                                                                                                                              }, {
                                                                                                                              }))), "table0_a"), "table0_b")), union(array(recDot(recRemove(recRemove(recConcat({
                                                                                                                                "table0_a": (recDot(stratify6, "_c0.a"))
                                                                                                                              }, recConcat({
                                                                                                                                  "table0_b": (recDot(stratify7, "_c0.b"))
                                                                                                                                }, recConcat({
                                                                                                                                    "table0_c": (recDot(stratify8, "_c0.c"))
                                                                                                                                  }, {
                                                                                                                                  }))), "table0_a"), "table0_b"), "table0_c")), array()))), (function (tsel$0) {
                                                                                                                                                                                                                                {
                                                                                                                  let stratify0$0;
                                                                                                                  {
                                                                                                                    ;
                                                                            ...
                                                                            ;
                                                                            {
                                                                              let tmp1 = distinct(array());
                                                                              {
                                                                                ...
                                                                                iterColl(array(contains(recConcat({
                                                                                          "table0_a": (recDot(stratify0$0, "_c0.a"))
                                                                                        }, recConcat({
                                                                                            "table0_b": (recDot(stratify1$0, "_c0.b"))
                                                                                          }, recConcat({
                                                                                              "table0_c": (recDot(stratify2, "_c0.c"))
                                                                                            }, {
                                                                                            }))), recDot(constants0, "table0"))), (function (tsel$0) {
                                                                                                                                                                        if (tsel$0) {
                                                                                      tmp1 = union(tmp1, array(array(tsel$0)));
                                                                                    } else {
                                                                                      tmp1 = union(tmp1, array(array()));
                                                                    ...
                                                                    ;
                                                                    {
                                                                      let stratify0$3;
                                                                      {
                                                                        ;
                                                                        {
                                                                          ...
                                                                          {
                                                                            ;
                                                                            iterColl(recDot(constants0, "table0"), (function (tsel$0) {
                                                                                                                                                                {
                                                                                  let stratify0$2;
                                                                                  {
                                                                                    ;
                                                                                            ...
                                                                                            ;
                                                                                            {
                                                                                              let stratify0$1;
                                                                                              {
                                                                                                ;
                                                                                                {
                                                                                                  ...
                                                                                                  {
                                                                                                    ;
                                                                                                    iterColl(union(array(recDot(tsel$0, "table0.a")), union(array(recDot(recRemove(tsel$0, "table0.a"), "table0.b")), union(array(recDot(recRemove(recRemove(tsel$0, "table0.a"), "table0.b"), "table0.c")), array()))), (function (tsel$1) {
                                                                                                                                                                                                                {
                                                                                                          let stratify0$0;
                                                                                                          {
                                                                                                            ;
                                                                        ...
                                                                        };
                                                                        {
                                                                          let stratify1$0;
                                                                          {
                                                                            ;
                                                                            {
                                                                              ...
                                                                              {
                                                                                ;
                                                                                iterColl(array((!natLe(count(flatten(stratify0$3)), {
                                                                                          "$nat": (0.0)
                                                                                        }))), (function (tsel$0) {
                                                                                                                                                                        if (tsel$0) {
                                                                                      tmp1 = union(tmp1, array(array(tsel$0)));
                                                                            ...
                                                                            tapp$3 = nth(flatten(stratify1$0), {
                                                                                  "$nat": (0.0)
                                                                                });
                                                                          }
                                                                        }
                              ...
                              let tappe$0;
                              {
                                    ...
                                    });;
                                {
                                  let stratify0$0;
                                  {
                                    ...
                                    tmp0 = union(tmp0, array(recConcat({
                                              "_c0_b": (recDot(stratify0$0, "_c0.b"))
                                            }, {
                                            })));
                                  }
                                }
