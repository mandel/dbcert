                                    ...
                                    };
                                    {
                                      let stratify2;
                                      {
                                        ...
                                        tmp0 = union(tmp0, array(recConcat({
                                                  "t2.a": (recDot(stratify0$0, "table1.a"))
                                                }, recConcat({
                                                    "t2.b": (recDot(stratify1, "table1.b"))
                                                  }, recConcat({
                                                      "t2.c": (recDot(stratify2, "table1.c"))
                                                    }, {
                                                    })))));
                                      }
                                    }
                                                                      ...
                                                                      let stratify2;
                                                                      {
                                                                        ...
                                                                        tmp1 = union(tmp1, array(recConcat({
                                                                                  "t1.a": (recDot(stratify0$0, "table1.a"))
                                                                                    ...
                                                                                    "t1.b": (recDot(stratify1$0, "table1.b"))
                                                                                  }, recConcat({
                                                                  ...
                                                                  let stratify0$0;
                                                                  {
                                                                    ...
                                                                    };
                                                                    {
                                                                      let stratify1$0;
                                                                      {
                                                                        ...
                                                                        tmp1 = union(tmp1, array(recConcat({
                                                                                  "t1_a": (recDot(stratify0$0, "t1.a"))
                                                                                }, recConcat({
                                                                                    "t1_b": (recDot(stratify1$0, "t1.b"))
                                                                                  }, {
                                                                                  }))));
                                                                      }
                                                                    }
                                                    ...
                                                    };
                                                    {
                                                      let stratify2;
                                                      {
                                                        ;
                                                        {
                                                          ...
                                                          {
                                                            ;
                                                            iterColl(array((!natLe(count(stratify1$1), {
                                                                      "$nat": (0.0)
                                                                    }))), (function (tsel$1) {
                                                                                                                                if (tsel$1) {
                                                                                    ...
                                                                                    ;
                                                                                    {
                                                                                      let tmp1 = distinct(array());
                                                                                      {
                                                                                        ...
                                                                                        iterColl(union(array(recDot(recConcat({
                                                                                                    "t1_a": (recDot(stratify0$1, "t2.a"))
                                                                                                  }, recConcat({
                                                                                                      "t1_b": (recDot(stratify1$0, "t2.b"))
                                                                                                    }, {
                                                                                                    })), "t1_a")), union(array(recDot(recRemove(recConcat({
                                                                                                        "t1_a": (recDot(stratify2, "t2.a"))
                                                                                                      }, recConcat({
                                                                                                          "t1_b": (recDot(stratify3, "t2.b"))
                                                                                                        }, {
                                                                                                        })), "t1_a"), "t1_b")), array())), (function (tsel$0) {
                                                                                                                                                                                        {
                                                                                              let stratify0$0;
                                                                                              {
                                                                                                ;
                                                                                          ...
                                                                                          let stratify3;
                                                                                          {
                                                                                            ...
                                                                                            };
                                                                                            {
                                                                                              let stratify4;
                                                                                              {
                                                                                                ...
                                                                                                tmp1 = union(tmp1, array(recConcat({
                                                                                                          "t1.a": (recDot(stratify2$0, "table1.a"))
                                                                                                        }, recConcat({
                                                                                                            "t1.b": (recDot(stratify3, "table1.b"))
                                                                                                          }, recConcat({
                                                                                                              "t1.c": (recDot(stratify4, "table1.c"))
                                                                                                            }, {
                                                                                                            })))));
                                                                                              }
                                                                                            }
                                                                                          ...
                                                                                          let stratify2$0;
                                                                                          {
                                                                                            ...
                                                                                            };
                                                                                            {
                                                                                              let stratify3$0;
                                                                                              {
                                                                                                ...
                                                                                                tmp1 = union(tmp1, array(recConcat({
                                                                                                          "t1_a": (recDot(stratify2$0, "t1.a"))
                                                                                                        }, recConcat({
                                                                                                            "t1_b": (recDot(stratify3$0, "t1.b"))
                                                                                                          }, {
                                                                                                          }))));
                                                                                              }
                                                                                            }
                                                                                ...
                                                                                ;
                                                                                {
                                                                                  let tmp1 = distinct(array());
                                                                                  {
                                                                                    ...
                                                                                    iterColl(array(contains(recConcat({
                                                                                              "t1_a": (recDot(stratify0$0, "t2.a"))
                                                                                            }, recConcat({
                                                                                                "t1_b": (recDot(stratify1$0, "t2.b"))
                                                                                              }, {
                                                                                              })), stratify3)), (function (tsel$0) {
                                                                                                                                                                                if (tsel$0) {
                                                                                          tmp1 = union(tmp1, array(array(tsel$0)));
                                                                                        } else {
                                                                                          tmp1 = union(tmp1, array(array()));
                                                                                                    ...
                                                                                                    ;
                                                                                                    {
                                                                                                      let stratify0$1;
                                                                                                      {
                                                                                                        ;
                                                                                                        {
                                                                                                          ...
                                                                                                          {
                                                                                                            ;
                                                                                                            iterColl(union(array(recDot(tsel$0, "t1_a")), union(array(recDot(recRemove(tsel$0, "t1_a"), "t1_b")), array())), (function (tsel$1) {
                                                                                                                                                                                                                                {
                                                                                                                  let stratify0$0;
                                                                                                                  {
                                                                                                                    ;
