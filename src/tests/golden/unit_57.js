                                                                      ...
                                                                      let stratify2;
                                                                      {
                                                                        ...
                                                                        tmp1 = union(tmp1, array(recConcat({
                                                                                  "_c0.a": (recDot(stratify0$0, "table1.a"))
                                                                                    ...
                                                                                    "_c0.b": (recDot(stratify1$0, "table1.b"))
                                                                                  }, recConcat({
                                                                      ...
                                                                      let stratify1$0;
                                                                      {
                                                                        ...
                                                                        tmp1 = union(tmp1, array(recConcat({
                                                                                  "_c0_a": (recDot(stratify0$0, "_c0.a"))
                                                                                    ...
                                                                                    "_c0_b": (recDot(stratify1$0, "_c0.b"))
                                                                                  }, {
                                                                                  }))));
                                                                      }
                                                                    }
                                                                                    ...
                                                                                    ;
                                                                                    {
                                                                                      let tmp1 = distinct(array());
                                                                                      {
                                                                                        ...
                                                                                        iterColl(union(array(recDot(recConcat({
                                                                                                    "_c0_a": (recDot(stratify0$1, "t1.a"))
                                                                                                  }, recConcat({
                                                                                                      "_c0_b": (recDot(stratify1$0, "t1.b"))
                                                                                                    }, {
                                                                                                    })), "_c0_a")), union(array(recDot(recRemove(recConcat({
                                                                                                        "_c0_a": (recDot(stratify2, "t1.a"))
                                                                                                      }, recConcat({
                                                                                                          "_c0_b": (recDot(stratify3, "t1.b"))
                                                                                                        }, {
                                                                                                        })), "_c0_a"), "_c0_b")), array())), (function (tsel$0) {
                                                                                                                                                                                        {
                                                                                              let stratify0$0;
                                                                                              {
                                                                                                ;
                                                                                          ...
                                                                                          let stratify3;
                                                                                          {
                                                                                            ...
                                                                                            };
                                                                                            {
                                                                                              let stratify4;
                                                                                              {
                                                                                                ...
                                                                                                tmp1 = union(tmp1, array(recConcat({
                                                                                                          "_c0.a": (recDot(stratify2$0, "table1.a"))
                                                                                                        }, recConcat({
                                                                                                            "_c0.b": (recDot(stratify3, "table1.b"))
                                                                                                          }, recConcat({
                                                                                                              "_c0.c": (recDot(stratify4, "table1.c"))
                                                                                                            }, {
                                                                                                            })))));
                                                                                              }
                                                                                            }
                                                                                          ...
                                                                                          let stratify2$0;
                                                                                          {
                                                                                            ...
                                                                                            };
                                                                                            {
                                                                                              let stratify3$0;
                                                                                              {
                                                                                                ...
                                                                                                tmp1 = union(tmp1, array(recConcat({
                                                                                                          "_c0_a": (recDot(stratify2$0, "_c0.a"))
                                                                                                        }, recConcat({
                                                                                                            "_c0_b": (recDot(stratify3$0, "_c0.b"))
                                                                                                          }, {
                                                                                                          }))));
                                                                                              }
                                                                                            }
                                                                                                    ...
                                                                                                    ;
                                                                                                    {
                                                                                                      let stratify0$1;
                                                                                                      {
                                                                                                        ;
                                                                                                        {
                                                                                                          ...
                                                                                                          {
                                                                                                            ;
                                                                                                            iterColl(union(array(recDot(tsel$0, "_c0_a")), union(array(recDot(recRemove(tsel$0, "_c0_a"), "_c0_b")), array())), (function (tsel$1) {
                                                                                                                                                                                                                                {
                                                                                                                  let stratify0$0;
                                                                                                                  {
                                                                                                                    ;
