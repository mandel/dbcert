                                                                      ...
                                                                      let stratify2;
                                                                      {
                                                                        ...
                                                                        tmp1 = union(tmp1, array(recConcat({
                                                                                  "t2.a": (recDot(stratify0$0, "table1.a"))
                                                                                    ...
                                                                                    "t2.b": (recDot(stratify1$0, "table1.b"))
                                                                                  }, recConcat({
                                                                  ...
                                                                  let stratify0$0;
                                                                  {
                                                                    ...
                                                                    };
                                                                    {
                                                                      let stratify1$0;
                                                                      {
                                                                        ...
                                                                        tmp1 = union(tmp1, array(recConcat({
                                                                                  "t2_a": (recDot(stratify0$0, "t2.a"))
                                                                                }, recConcat({
                                                                                    "t2_b": (recDot(stratify1$0, "t2.b"))
                                                                                  }, {
                                                                                  }))));
                                                                      }
                                                                    }
                                                                                    ...
                                                                                    ;
                                                                                    {
                                                                                      let tmp1 = distinct(array());
                                                                                      {
                                                                                        ...
                                                                                        iterColl(union(array(recDot(recConcat({
                                                                                                    "t2_a": (recDot(stratify0$1, "t1.a"))
                                                                                                  }, recConcat({
                                                                                                      "t2_b": (recDot(stratify1$0, "t1.b"))
                                                                                                    }, {
                                                                                                    })), "t2_a")), union(array(recDot(recRemove(recConcat({
                                                                                                        "t2_a": (recDot(stratify2, "t1.a"))
                                                                                                      }, recConcat({
                                                                                                          "t2_b": (recDot(stratify3, "t1.b"))
                                                                                                        }, {
                                                                                                        })), "t2_a"), "t2_b")), array())), (function (tsel$0) {
                                                                                                                                                                                        {
                                                                                              let stratify0$0;
                                                                                              {
                                                                                                ;
                                                                                          ...
                                                                                          let stratify3;
                                                                                          {
                                                                                            ...
                                                                                            };
                                                                                            {
                                                                                              let stratify4;
                                                                                              {
                                                                                                ...
                                                                                                tmp1 = union(tmp1, array(recConcat({
                                                                                                          "t2.a": (recDot(stratify2$0, "table1.a"))
                                                                                                        }, recConcat({
                                                                                                            "t2.b": (recDot(stratify3, "table1.b"))
                                                                                                          }, recConcat({
                                                                                                              "t2.c": (recDot(stratify4, "table1.c"))
                                                                                                            }, {
                                                                                                            })))));
                                                                                              }
                                                                                            }
                                                                                          ...
                                                                                          let stratify2$0;
                                                                                          {
                                                                                            ...
                                                                                            };
                                                                                            {
                                                                                              let stratify3$0;
                                                                                              {
                                                                                                ...
                                                                                                tmp1 = union(tmp1, array(recConcat({
                                                                                                          "t2_a": (recDot(stratify2$0, "t2.a"))
                                                                                                        }, recConcat({
                                                                                                            "t2_b": (recDot(stratify3$0, "t2.b"))
                                                                                                          }, {
                                                                                                          }))));
                                                                                              }
                                                                                            }
                                                                                                    ...
                                                                                                    ;
                                                                                                    {
                                                                                                      let stratify0$1;
                                                                                                      {
                                                                                                        ;
                                                                                                        {
                                                                                                          ...
                                                                                                          {
                                                                                                            ;
                                                                                                            iterColl(union(array(recDot(tsel$0, "t2_a")), union(array(recDot(recRemove(tsel$0, "t2_a"), "t2_b")), array())), (function (tsel$1) {
                                                                                                                                                                                                                                {
                                                                                                                  let stratify0$0;
                                                                                                                  {
                                                                                                                    ;
